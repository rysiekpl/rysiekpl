...
I mostly stay away from Microslop GitHub, only using it when I absolutely *must* due to specific projects I rely on. Find my code elsewhere:
...
Here are some reasons not to use Microslop GitHub:
